...
from app.users.models.users import Message, NewPassword, Token, UserPublic
...
async def login_access_token(
    ...
    # except:
    #     raise HTTPException(status_code=400, detail="Voce ainda não cadastrou a senha. Verifique seu email!")
    if not user:
